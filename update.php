...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `crud` SET id=$id, name = '$name', email = '$email', comment = '$comment' WHERE id = $id";
...
<body>
    ...
    <label>ID</label>
    <input type="text" class="form-control" placeholder="enter id" name="id" autocomplete="off" value= <?php echo $id; ?>>
</div>
          ...
          <div class="form-group">
            <label>Name</label>
            <input type="text" class="form-control"placeholder="Name placeholder" name ="name"autocomplete="off" value= "<?php echo $name; ?>">
          </div>
        ...
        <div class="form-group">
          <label >Comment</label>
          <textarea class="form-control" rows="3" name="comment" autocomplete="off"><?php echo $comment;  ?> </textarea>
        </div>
